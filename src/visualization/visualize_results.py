...
def plot_ablation_performance(ablation_dir, output_dir):
    ...
    # Standard KD baseline reference line (F1=0.8770 from FINAL_STATS)
    ax.axhline(y=0.877, color='gray', linestyle='--', alpha=0.6, linewidth=1.2,
               label='Standard KD F1 Baseline (0.877)')
